...
function headlines_init()
{
 ...
 // Initialisation successful and complete to version 1.2.1 now continue at 1.2.1 for any new or upgraded code
    return headlines_upgrade('1.2.1');
}
